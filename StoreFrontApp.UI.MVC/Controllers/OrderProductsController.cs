...
namespace StoreFrontApp.UI.MVC.Controllers
{
    ...
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(StoreFrontAppContext context)
        {
            _context = context;
        }
        ...
        {
            var storeFrontAppContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreFrontAppContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
