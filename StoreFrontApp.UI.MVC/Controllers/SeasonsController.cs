...
namespace StoreFrontApp.UI.MVC.Controllers
{
    ...
    public class SeasonsController : Controller
    {
        ...
        public SeasonsController(StoreFrontAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SeasonId,SeasonType,SeasonDescription")] Season season)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SeasonId,SeasonType,SeasonDescription")] Season season)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreFrontAppContext.Seasons'  is null.");
            }
            var season = await _context.Seasons.FindAsync(id);
            if (season != null)
            {
